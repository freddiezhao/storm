 ...
 */
public class UvWithPlatformAppCountBolt implements IRichBolt {

	private static final long serialVersionUID = 6791273155452013488L;

	private static final Logger logger = LoggerFactory
			.getLogger(UvWithPlatformAppCountBolt.class);
	...
	/** 线图-app uv历史点入库rowkey */
	private String rowkey_app_uv_count = null;
	/** 线图-app uv最后累加值入库rowkey */
	private String rowkey_app_uv_last = null;
			...
			if (compd.equals(curTime)) {
				...
				synchronized (this) {
					...
					if (insertDB_endTime - insertDB_startTime >= Constant.SECOND_50) {
						rowkey_app_uv_count = curTime + "_app_uv_" + strLastXValue[0].replace(".", "");
				...
				curTime = compd;
				rowkey_app_uv_last = "last_tracker_app_uv_" + curTime;
				app_uv_count = 0;
			}
	...
	public void prepare(Map stormConf, TopologyContext context,
		...
		try {
			...
			rowkey_app_uv_last = "last_tracker_app_uv_" + curTime;
			app_uv_count = Long.parseLong(dao.getColumnValue(Constant.TABLE_TRACKER_UV_RESULT, rowkey_app_uv_last,
