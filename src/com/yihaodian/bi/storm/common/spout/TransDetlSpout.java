 ...
 *
 */
public class TransDetlSpout implements IRichSpout{
	
	private static final long serialVersionUID = -7832339753486267481L;
	private final Logger logger = LoggerFactory.getLogger(TransDetlSpout.class);
	...
	public TransDetlSpout(String consumerName)
	{
