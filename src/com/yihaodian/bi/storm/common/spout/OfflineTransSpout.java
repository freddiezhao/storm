 ...
 *
 */
public class OfflineTransSpout implements IRichSpout{
	
	private static final long serialVersionUID = -353675221316868076L;
	private final Logger logger = LoggerFactory.getLogger(OfflineTransSpout.class);
	private SpoutOutputCollector collector;
	private Gos_create_so createSo;
	
	private String consumerName;
	
	public OfflineTransSpout(String consumerName)
	{
